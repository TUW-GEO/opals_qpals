...
class QpalsProject:
    ...
    def getUI(self):
        ...
        self.txtOpalspath = QpalsDropTextbox.QpalsDropTextbox()
        self.txtOpalspath.setText(self.opalspath)
        self.txtWorkdir = QpalsDropTextbox.QpalsDropTextbox()
        self.txtWorkdir.setText(self.workdir)
        self.txtTempdir = QpalsDropTextbox.QpalsDropTextbox(self.tempdir)
        ...
        lo.addRow(QtGui.QLabel("Path to opals binaries*"), self.txtOpalspath)
        lo.addRow(QtGui.QLabel("Working directory**"), self.txtWorkdir)
        lo.addRow(QtGui.QLabel("Temporary directory**"), self.txtTempdir)
